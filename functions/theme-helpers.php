...
{
	global $post;
	return $output . '<a class="btn btn-lg btn-bkc-success rounded-0 read-more" type="button" style="text-decoration:none;" href="' . get_permalink() . '">Keep Reading  <i class="fas fa-arrow-right fa-fw text-white"></i></a><br>';
}
